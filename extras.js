...
const PAINEL = {
  ...
  fichamento: [
    ...
    { sigla:"Hist. Dir.", blocos:[
      ...
      { titulo:"Temas, datas e bibliografia", texto:"Direito na Grécia, em 03/09: “Direito na Grécia Antiga” (slides no Moodle), BAGNOLI; BARBOSA; OLIVEIRA, Introdução à História do Direito, Atlas, 2014, pp. 31-42. Direito em Roma, em 10/09: “Direito em Roma” (slides), mesma obra, pp. 44-55. Direito na Idade Média, em 17/09: “O Direito na Idade Média” (slides), mesma obra, pp. 57-76. Direito na América Espanhola e Portuguesa, em 15/10: “Direito e barbárie na conquista da América indígena” (texto em PDF e slides), mesma obra e texto disponibilizado no Moodle. Revolução Francesa e Direito Moderno, em 22/10: “A Revolução Francesa e a Evolução do Estado Liberal ao Estado Democrático de Direito” (slides), GRIVOT, Débora C. H. et al., História do Direito, Grupo A, 2017 (Minha Biblioteca), pp. 127-150. Direito no Império, em 29/10: “Brasil Império — História do Direito” (slides), BAGNOLI et al., pp. 128-143. Direito na República, em 05/11: “A Construção da República no Brasil (1889-1943)” (slides), BAGNOLI et al., pp. 144-172. Atenção: todas essas datas são estimativa. O cronograma do professor é o do 1º semestre de 2026, quando a disciplina era às quartas-feiras; neste semestre ela é às quintas, e as datas foram reposicionadas mantendo o mesmo espaçamento entre as aulas. Confirme com o professor antes de fechar o cronograma do grupo." },
